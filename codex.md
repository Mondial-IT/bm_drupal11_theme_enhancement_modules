...
- Repository location: `web/modules/custom/bm_theme_enhancement_modules`
...
| codex.features_1.md | general functionality enhancements | active  |
...
* only files under `web/modules/custom/bm_theme_enhancement_modules` are allowed to be changed or be added to it.
